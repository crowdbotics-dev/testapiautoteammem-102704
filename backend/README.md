...
## Project Structure
    ...
    ├── testapiautoteammem_102704  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_102704`
...
2. Clone this repo and `cd testapiautoteammem_102704`
